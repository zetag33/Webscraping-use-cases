This repository is intended to be a tutorial on how to build core code infrastructure and methodology for most common webscraping use-cases as well as showing which are those most common use-cases.
